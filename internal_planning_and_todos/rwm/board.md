# Board — 2026-09-06 07:30Z — HAND-OFF (TRI SageMaker via the lead only; project home is github.com/Servo97/cross-task-deliberative-supervision)
...
| **RoboMME base curve LANDED 07:17Z 09-06** | 112/112 cells (5.5 h, one p5 node): 12.0/12.9/14.1/15.1/**16.75**/16.5/14.4 % at 10k…60k/69999 (execute-10 lane, 800 eps each; §57, `E-rmme-base-curve-a19`). Rise +4.75 pp to a 50–60k plateau, −2.4 pp at 69999 (n.s.). A19 rule degenerate at MDE 5 → s*=10000; 2 SE → 30000; argmax 50000. **USER DECISION: common arm step** (+ optional paper-protocol re-score of 30k/50k/69999 on Babel) | cells + JSON in `s3_salvage/…/fixed50_campaigns/…` |
